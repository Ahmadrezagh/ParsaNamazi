...
{{--                            </button>--}}
                ...
                @if(\App\Models\CountDown::query()->started()->notExpired()->count() > 0)
                                    ...
                                    <div class="card-body">
                                        <div class="card-item">
                                            ...
                                            <div class="card-item-title mb-2 text-center">
                                                <label class="main-content-label tx-13 font-weight-bold mb-1"><h5>Total Cash</h5></label>
                                                <h4 class="font-weight-bold mt-1">${{number_format(auth()->user()->cash)}}</h4>
{{--                                                <span class="d-block tx-12 mb-0 text-muted">Previous month vs this months</span>--}}
                                            </div>
                                            <div class="card-item-body text-center">
                                                <div class="card-item-stat text-center">
                                                    <small>
                                                        <button class="btn btn-primary"  data-toggle="modal" data-target="#modal-create">withdrawal</button>
                                                    </small>
                                                </div>
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="card-item">
                                            ...
                                            <div class="card-item-title mb-2 text-center">
                                                <label class="main-content-label tx-13 font-weight-bold mb-1"><h5>My Referrals</h5></label>

                                                <h4 class="font-weight-bold mt-1">{{ auth()->user()->myRefers()->count() }}</h4>
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="card-item">
                                            ...
                                            <div class="card-item-title  mb-2 text-center">
                                                <label class="main-content-label tx-13 font-weight-bold mb-1"><h5>Credit</h5></label>
                                                <h4 class="font-weight-bold">{{ auth()->user()->credit }}</h4>
{{--                                                <span class="d-block tx-12 mb-0 text-muted">Previous month vs this months</span>--}}
                                            </div>
                                            <div class="card-item-body">
                                                <div class="card-item-stat">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6 my-auto">
                                                ...
                                                <div class="text-left">
                                                    <h3 class="font-weight-bold mr-3 mb-2 text-primary">{{auth()->user()->chestActivities()->where('chest_id','=',$active_chest->id)->count()}} / {{$active_chest->required_online_days}} Days</h3>
...
{{--                                                </div>--}}
                            ...
                            @foreach(auth()->user()->chestGift()->NotExpired()->get() as $chest_gift)
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="card custom-card overflow-hidden">
                                            <div class="card-header  border-bottom-0 pb-0">
                                                <div>
                                                    <div class="d-flex">
                                                        <label class="main-content-label my-auto pt-2">{{ $chest_gift->chest->title }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex align-middle ml-3">
                                                                                        <div class="d-inline-block">
                                                                                            ...
                                                                                            <p class="mb-0 tx-13 text-muted">Referred by: {{$referUser->referTo->name ?? ' - '}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td class="text-right">
...
@section('js')
    ...
    @foreach(\App\Models\Chest::query()->active()->get() as $active_chest)
        @if(!auth()->user()->chestGift()->where('chest_id','=',$active_chest->id)->NotExpired()->first())
            <script>
                let active_days = {{auth()->user()->chestActivities()->where('chest_id','=',$active_chest->id)->count() }};
