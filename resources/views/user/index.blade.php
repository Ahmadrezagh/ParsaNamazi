                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="card-item">
                                            ...
                                            <div class="card-item-title mb-2">
                                                <label class="main-content-label tx-13 font-weight-bold mb-1">My Referrals</label>
                                                <span class="d-block tx-12 mb-0 text-muted" >        </span>
                                            </div>
                                            <div class="card-item-body">
                                                <div class="card-item-stat">
                                                    <h4 class="font-weight-bold">{{ auth()->user()->myRefers()->count() }}</h4>
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="card-item">
                                            ...
                                            <div class="card-item-title  mb-2">
                                                <label class="main-content-label tx-13 font-weight-bold mb-1">Pop ups you clicked</label>
{{--                                                <span class="d-block tx-12 mb-0 text-muted">Previous month vs this months</span>--}}
                                            </div>
                                            <div class="card-item-body">
                                                <div class="card-item-stat">
                                                    <h4 class="font-weight-bold">50 times</h4>
                                                    <div style="padding-bottom: 38px"></div>
                                                </div>
                                            </div>
                                        </div>
